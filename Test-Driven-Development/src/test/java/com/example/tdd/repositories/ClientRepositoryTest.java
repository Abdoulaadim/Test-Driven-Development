...
public class ClientRepositoryTest {
    ...
    @Test
    void update() {
        ClientEntity clt =new ClientEntity(5L,"sept1aa@gmail.com","0628640782","cltsave",12,"homme",true);
        clt.setNom("updated");
        ClientEntity cltsaved =clientRepository.save(clt);
        assertEquals("updated",cltsaved.getNom());
        assertEquals(5L,cltsaved.getId());
    ...
    void byemail() {
       /* ClientEntity clt =new ClientEntity(0L,"cltsave@gmail.com","0648640763","cltsave",12,"homme",true);
        ClientEntity cltsaved =clientRepository.save(clt);*/
        ClientEntity byemail =clientRepository.findByEmail("abdoulaadim@gmail.com");

        assertEquals("abdoulaadim@gmail.com",byemail.getEmail());
    ...
    void byid() {
        ...
        ClientEntity byId =clientRepository.findById(1L);
        assertEquals("abdoulaadim@gmail.com",byId.getEmail());
...
//        assertEquals(1,clientRepository.deleteById(1));
    ...
    void bysex() {
        ...
        List<ClientEntity> byemail =clientRepository.findBySex("home");
